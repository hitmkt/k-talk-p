...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 320" width="800" height="320">
  ...
  <!-- 감탄배송 뱃지 -->
  <rect x="24" y="28" width="150" height="44" rx="10" fill="${BLUE}"/>
  <!-- 배 아이콘 -->
  <path d="M36 54 L38 46 L44 46 L46 54 Z" fill="#7dd3fc" stroke="#fff" stroke-width="0.8"/>
  <path d="M33 54 Q40 60 47 54 Z" fill="#38bdf8"/>
  <line x1="40" y1="46" x2="40" y2="42" stroke="#fff" stroke-width="1.5" stroke-linecap="round"/>
  <path d="M40 42 L45 46" stroke="#fff" stroke-width="1" stroke-linecap="round" fill="none"/>
  <path d="M31 56 Q40 62 49 56" stroke="#93c5fd" stroke-width="1.5" fill="none" stroke-linecap="round"/>
  <text x="130" y="56" fill="#fff" font-size="20" font-weight="bold" font-family="sans-serif" text-anchor="middle">\uac10\ud0c4\ubc30\uc1a1</text>

  <!-- 상단 타이틀 -->
  <text x="190" y="58" fill="#111" font-size="32" font-weight="bold" font-family="sans-serif">${titleText}</text>
  ...
  <circle cx="618" cy="267" r="6" fill="${accent}"/>
  <text x="630" y="271" fill="${accent}" font-size="17" font-weight="bold" font-family="sans-serif">${footerRight}</text>
</svg>`;
