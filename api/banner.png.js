...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 320" width="800" height="320">
  ...
  <text x="92" y="56" fill="#fff" font-size="20" font-weight="bold" font-family="sans-serif" text-anchor="middle">\uac10\ud0c4\ubc30\uc1a1</text>
  ...
  <!-- 중단 -->
  <text x="24" y="152" font-size="30" font-weight="bold" font-family="sans-serif">
    <tspan fill="#111">${midMain}</tspan>
    <tspan fill="${RED}">${midAccent}</tspan>${noteHtml}
  </text>

  <!-- 무료배송 -->
  <text x="24" y="210" fill="${BLUE}" font-size="32" font-weight="bold" font-family="sans-serif">\ubb34\ub8cc\ubc30\uc1a1</text>

  <!-- 하단 바 -->
  <rect x="24" y="232" width="752" height="64" rx="14" fill="#f4f4fa"/>
  <rect x="34" y="246" width="88" height="28" rx="14" fill="#3b38d3"/>
  <text x="78" y="265" fill="#fff" font-size="16" font-weight="bold" font-family="sans-serif" text-anchor="middle">\uac10\ud0c4\ud64d\uac8c</text>
  <text x="132" y="265" fill="#444" font-size="17" font-family="sans-serif">${footerLeft}</text>
  <text x="500" y="265" fill="${accent}" font-size="17" font-weight="bold" font-family="sans-serif">\u25CF ${footerRight}</text>
</svg>`;
