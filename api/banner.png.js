...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 320" width="800" height="320">
  ...
  <!-- 감탄배송 뱃지 -->
  <rect x="24" y="28" width="148" height="44" rx="10" fill="${BLUE}"/>
  <!-- 배 아이콘 (뱃지 왼쪽 여백 딱 붙게) -->
  ...
  <!-- 배 아이콘과 텍스트 한 칸 간격 -->
  <text x="52" y="56" fill="#fff" font-size="20" font-weight="bold" font-family="sans-serif">\uac10\ud0c4\ubc30\uc1a1</text>

  <!-- 상단 타이틀 -->
  <text x="188" y="58" fill="#111" font-size="32" font-weight="bold" font-family="sans-serif">${titleText}</text>
