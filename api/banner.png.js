...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 320" width="800" height="320">
  ...
  <!-- 감탄배송 뱃지 -->
  <rect x="24" y="28" width="172" height="44" rx="10" fill="${BLUE}"/>
  <!-- 배 아이콘 -->
  <path d="M34 54 L36 46 L42 46 L44 54 Z" fill="#7dd3fc" stroke="#fff" stroke-width="0.8"/>
  <path d="M31 54 Q38 60 45 54 Z" fill="#38bdf8"/>
  <line x1="38" y1="46" x2="38" y2="42" stroke="#fff" stroke-width="1.5" stroke-linecap="round"/>
  <path d="M38 42 L43 46" stroke="#fff" stroke-width="1" stroke-linecap="round" fill="none"/>
  <path d="M29 56 Q38 62 47 56" stroke="#93c5fd" stroke-width="1.5" fill="none" stroke-linecap="round"/>
  <!-- 텍스트 뱃지 중앙 정렬 -->
  <text x="110" y="56" fill="#fff" font-size="22" font-weight="bold" font-family="sans-serif" text-anchor="middle">\uac10\ud0c4\ubc30\uc1a1</text>

  <!-- 상단 타이틀 -->
  <text x="210" y="58" fill="#111" font-size="32" font-weight="bold" font-family="sans-serif">${titleText}</text>
  ...
  <text x="628" y="273" fill="${accent}" font-size="20" font-weight="bold" font-family="sans-serif">${footerRight}</text>
</svg>`;
