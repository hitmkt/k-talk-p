...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 320" width="800" height="320">
  ...
  <!-- 감탄홍게 뱃지 (세로 중앙: y=238+29=267, 뱃지 높이28 → y=253) -->
  ...
  <!-- 하단 좌측 메시지 (세로 중앙 y=271) -->
  <text x="132" y="271" fill="#444" font-size="17" font-family="sans-serif">${footerLeft}</text>

  <!-- 하단 우측: ● + 출고레이블 (x=500 고정) -->
  <circle cx="494" cy="267" r="6" fill="${accent}"/>
  <text x="506" y="271" fill="${accent}" font-size="17" font-weight="bold" font-family="sans-serif">${footerRight}</text>
</svg>`;
