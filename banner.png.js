module.exports = async (req, res) => {
  ...
  /* 하단 2줄:
     ...
     2줄: 출고 레이블
  */
  const footerLine1=before
    ?`\uc624\ub298 \uc624\ud6c4 ${cutH}\uc2dc \uc8fc\ubb38 \ub9c8\uac10 \u00B7 \ub2f9\uc77c \ucd9c\uace0`
    :`\uc624\ub298 \ucd9c\uace0 \uc885\ub8cc \u00B7 \ub0b4\uc77c \uc624\ud6c4 ${nextCutH}\uc2dc\uae4c\uc9c0 \uc8fc\ubb38 \uc2dc`;
  const footerLine2=before
    ?`\u25CF \uc624\ub298(${DAYS[k.dow]}) \ucd9c\uace0 \u27A1`
    :`\u25CF ${shipDay}\uc694\uc77c \ucd9c\uace0 \u27A1`;

  /* viewBox 800x240 — PC/모바일 공용, width=100% 로 img 태그에서 제어 */
  const svg=`<?xml version="1.0" encoding="UTF-8"?>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 240" width="800" height="240">
  <rect width="800" height="240" rx="16" fill="#fff" stroke="#eee" stroke-width="1.5"/>
  ...
  <!-- 하단 바 (2줄) -->
  <rect x="20" y="164" width="760" height="60" rx="12" fill="#f4f4fa"/>

  <!-- 감탄홍게 뱃지 -->
  <rect x="30" y="174" width="72" height="22" rx="11" fill="#3b38d3"/>
  <text x="66" y="189" fill="#fff" font-size="12" font-weight="bold" font-family="sans-serif" text-anchor="middle">\uac10\ud0c4\ud64d\uac8c</text>

  <!-- 하단 1줄 메시지 -->
  <text x="112" y="189" fill="#444" font-size="14" font-family="sans-serif">${footerLine1}</text>

  <!-- 하단 2줄 출고 레이블 -->
  <text x="112" y="212" fill="${accent}" font-size="14" font-weight="bold" font-family="sans-serif">${footerLine2}</text>
</svg>`;
