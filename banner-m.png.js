module.exports = async (req, res) => {
  ...
  const noteHtml=showNote?`<tspan fill="#b84040" font-size="16"> (\uc74d,\uba74,\ub9ac \uc81c\uc678)</tspan>`:'';

  /* 모바일: 420x220 */
  const svg=`<?xml version="1.0" encoding="UTF-8"?>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 420 220" width="420" height="220">
  <rect width="420" height="220" rx="14" fill="#fff" stroke="#eee" stroke-width="1.5"/>
  <rect x="14" y="16" width="92" height="28" rx="7" fill="${BLUE}"/>
  <text x="60" y="34" fill="#fff" font-size="13" font-weight="bold" font-family="sans-serif" text-anchor="middle">\uD83C\uDF0A \uac10\ud0c4\ubc30\uc1a1</text>
  <text x="116" y="35" fill="#111" font-size="18" font-weight="bold" font-family="sans-serif">${titleText}</text>
  <line x1="14" y1="57" x2="406" y2="57" stroke="#f0f0f0" stroke-width="1"/>
  <text x="14" y="95" font-size="19" font-weight="bold" font-family="sans-serif">
    <tspan fill="#555">\uD83D\uDD52 </tspan>
    <tspan fill="#111">${midMain}</tspan>
    <tspan fill="${RED}">${midAccent}</tspan>${noteHtml}
  </text>
  <text x="14" y="130" fill="${BLUE}" font-size="21" font-weight="bold" font-family="sans-serif">\ubb34\ub8cc\ubc30\uc1a1</text>
  <rect x="14" y="146" width="392" height="58" rx="12" fill="#f4f4fa"/>
  <rect x="22" y="157" width="70" height="22" rx="11" fill="#3b38d3"/>
  <text x="57" y="172" fill="#fff" font-size="12" font-weight="bold" font-family="sans-serif" text-anchor="middle">\uac10\ud0c4\ud64d\uac8c</text>
  <text x="100" y="170" fill="#444" font-size="13" font-family="sans-serif">${footerMsg}</text>
  <text x="100" y="190" fill="${accent}" font-size="13" font-weight="bold" font-family="sans-serif">&#x25CF; ${shipLabel}</text>
</svg>`;
